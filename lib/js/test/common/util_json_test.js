...
function from_json(j) {
  return Util_option.$great$great$eq(Util_json.jdict_of_json(j), (function (d) {
                return Curry._2(Util_option.$less$neg$great, Curry._2(Util_option.$less$neg$great, Curry._2(Util_option.$less$neg$great, Curry._2(Util_option.$less$neg$great, Curry._2(Util_option.$less$neg$great, Curry._2(Util_option.$less$$great, make, Curry._2(Util_json.Int[/* get */4], d, "i")), Curry._2(Util_json.Float[/* get */4], d, "f")), Curry._2(Util_json.$$String[/* get */4], d, "s")), Util_json.get_array(from_json, d, "arr")), Curry._2(FloatArray[/* get */4], d, "arr2")), Curry._2(IntList[/* get */4], d, "lst"));
              }));
}
