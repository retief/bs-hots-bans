...
function from_json(j) {
  return Curry._2(Util_monad.Option[/* >>= */1], Js_json.decodeObject(j), (function (d) {
                return Curry._2(Util_monad.Option[/* >>= */1], Curry._2(Util_monad.Option[/* >>= */1], Js_primitive.undefined_to_opt(d["i"]), Util_json.Int[/* from_json */0]), (function (i) {
                              return Curry._2(Util_monad.Option[/* >>= */1], Curry._2(Util_monad.Option[/* >>= */1], Js_primitive.undefined_to_opt(d["s"]), Util_json.$$String[/* from_json */0]), (function (s) {
                                            return Curry._2(Util_monad.Option[/* >>= */1], Curry._2(Util_monad.Option[/* >>= */1], Js_primitive.undefined_to_opt(d["arr"]), (function (param) {
                                                              return Util_json.array_of_jarray(from_json, param);
                                                            })), (function (arr) {
                                                          var partial_arg = Util_json.Int[/* from_json */0];
                                                          return Curry._2(Util_monad.Option[/* >>= */1], Curry._2(Util_monad.Option[/* >>= */1], Js_primitive.undefined_to_opt(d["lst"]), (function (param) {
                                                                            return Util_json.list_of_jarray(partial_arg, param);
                                                                          })), (function (lst) {
                                                                        return Curry._2(Util_monad.Option[/* >>= */1], Curry._2(Util_monad.Option[/* >>= */1], Js_primitive.undefined_to_opt(d["f"]), Util_json.Float[/* from_json */0]), (function (f) {
                                                                                      return Curry._1(Util_monad.Option[/* pure */2], /* record */[
                                                                                                  /* arr */arr,
                                                                                                  /* lst */lst,
                                                                                                  /* i */i,
                                                                                                  /* f */f,
