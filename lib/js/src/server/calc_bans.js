...
function get_heroes() {
  var partial_arg = Hero_list$1[/* from_json */0];
  return Curry._2(Util_promise.$pipe$$great, Curry._2(Util_promise.$pipe$$great, Request.get_json("https://api.hotslogs.com/Public/Data/Heroes"), (function (param) {
                    return Util.$percent(partial_arg, Util.debug, param);
                  })), (function (param) {
