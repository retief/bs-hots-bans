...
function Extend(M) {
  ...
  var get = function (d, s) {
    return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), M[/* from_json */0]);
  };
  var $at$dot = get;
  return /* module */[
          /* from_json */M[0],
...
function get(d, s) {
  return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), Js_json.decodeString);
}
...
function get$1(d, s) {
  return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), from_json);
}
...
function get$2(d, s) {
  return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), Js_json.decodeNumber);
}
...
function get_array(f, d, s) {
  return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), (function (param) {
                return array_of_jarray(f, param);
              }));
}

function get_list(f, d, s) {
  return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), (function (param) {
                return list_of_jarray(f, param);
              }));
}
...
function List(M) {
  ...
  var stringify = function (v) {
    return JSON.stringify(to_json(v));
  };
  var get = function (d, s) {
    return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), from_json);
  };
...
function $$Array$1(M) {
  ...
  var stringify = function (v) {
    return JSON.stringify($$Array.map(M[/* to_json */1], v));
  };
  var get = function (d, s) {
    return Util_option.$great$great$eq(Js_primitive.undefined_to_opt(d[s]), from_json);
  };
...
var jobj_of_list = Js_dict.fromList;

var jdict_of_json = Js_json.decodeObject;
...
exports.jdict_of_json   = jdict_of_json;
exports.jobj_of_list    = jobj_of_list;
