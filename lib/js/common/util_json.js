...
function from_json(n) {
  return Curry._2(Util_monad.Option[/* map */7], (function (prim) {
                return prim | 0;
...
function list_of_jarray(f, a) {
  return Curry._2(Util_monad.Option[/* >>= */1], Curry._2(Util_monad.Option[/* map */7], $$Array.to_list, Js_json.decodeArray(a)), Curry._1(Util_monad.Option[/* mapM */13], f));
}

function array_of_jarray(f, a) {
  try {
    var arr = Js_json.decodeArray(a);
    var unpack_exn = function (param) {
      if (param) {
        return param[0];
      } else {
        throw [
    ...
    return /* Some */[$$Array.map((function (param) {
                    return Util_kernel.compose(unpack_exn, f, param);
                  }), unpack_exn(arr))];
  }
  catch (raw_exn){
